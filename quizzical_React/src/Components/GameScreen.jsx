      ...
      {loading ? (
        ...
        <div className="game-screen--qna">
          {triviaData?.map((qanda, index) => (
            <>
              <p>{he.decode(qanda.question)}</p>
              <ul className="game-screen--ans">
                <li key={nanoid()}>
                  <label>{he.decode(triviaAns[index][0])}</label>
                  <input
                    type="radio"
                    name={index}
                    onChange={handleChange}
                ...
                <li key={nanoid()}>
                  <label>{he.decode(triviaAns[index][1])}</label>
                  <input
                    type="radio"
                    name={index}
                    onChange={handleChange}
                ...
                <li key={nanoid()}>
                  <label>{he.decode(triviaAns[index][2])}</label>
                  <input
                    type="radio"
                    name={index}
                    onChange={handleChange}
                ...
                <li key={nanoid()}>
                  <label>{he.decode(triviaAns[index][3])}</label>
                  <input
                    type="radio"
                    name={index}
                    onChange={handleChange}
